...
export class DFOAParser extends antlr.Parser {
    ...
    public static readonly RULE_print_statement = 6;
    public static readonly RULE_expr_statement = 7;
    public static readonly RULE_semi = 8;
    ...
    public static readonly ruleNames = [
        "start", "tlStatement", "func", "paramslist", "block", "statement", 
        "print_statement", "expr_statement", "semi", "ident", "expr", "literal",
    ];
    ...
    public block(): BlockContext {
        ...
        this.enterRule(localContext, 8, DFOAParser.RULE_block);
        let _la: number;
        try {
            this.state = 51;
            this.errorHandler.sync(this);
    ...
    public statement(): StatementContext {
        ...
        this.enterRule(localContext, 10, DFOAParser.RULE_statement);
        try {
            this.state = 56;
            this.errorHandler.sync(this);
            switch (this.tokenStream.LA(1)) {
    ...
    public print_statement(): Print_statementContext {
        ...
        this.enterRule(localContext, 12, DFOAParser.RULE_print_statement);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 58;
    ...
    public expr_statement(): Expr_statementContext {
        let localContext = new Expr_statementContext(this.context, this.state);
        this.enterRule(localContext, 14, DFOAParser.RULE_expr_statement);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 62;
    ...
    public semi(): SemiContext {
        ...
        this.enterRule(localContext, 16, DFOAParser.RULE_semi);
        try {
            this.enterOuterAlt(localContext, 1);
            {
            this.state = 65;
    ...
    public static readonly _serializedATN: number[] = [
        ...
        4,1,4,5,4,45,8,4,10,4,12,4,48,9,4,1,4,1,4,3,4,52,8,4,1,5,1,5,1,5,
        3,5,57,8,5,1,6,1,6,1,6,1,6,1,7,1,7,1,7,1,8,1,8,1,9,1,9,1,10,1,10,
        ...
        0,0,8,51,1,0,0,0,10,56,1,0,0,0,12,58,1,0,0,0,14,62,1,0,0,0,16,65,
        ...
        3,1,0,0,0,34,35,5,1,0,0,35,36,3,18,9,0,36,37,3,6,3,0,37,38,3,8,4,
        0,38,5,1,0,0,0,39,40,5,5,0,0,40,41,5,6,0,0,41,7,1,0,0,0,42,46,5,
        3,0,0,43,45,3,10,5,0,44,43,1,0,0,0,45,48,1,0,0,0,46,44,1,0,0,0,46,
        47,1,0,0,0,47,49,1,0,0,0,48,46,1,0,0,0,49,52,5,4,0,0,50,52,3,10,
        5,0,51,42,1,0,0,0,51,50,1,0,0,0,52,9,1,0,0,0,53,57,3,12,6,0,54,57,
        3,14,7,0,55,57,3,16,8,0,56,53,1,0,0,0,56,54,1,0,0,0,56,55,1,0,0,
        0,57,11,1,0,0,0,58,59,5,2,0,0,59,60,3,20,10,0,60,61,5,9,0,0,61,13,
        1,0,0,0,62,63,3,20,10,0,63,64,5,9,0,0,64,15,1,0,0,0,65,66,5,9,0,
        0,66,17,1,0,0,0,67,68,7,0,0,0,68,19,1,0,0,0,69,70,3,22,11,0,70,21,
        1,0,0,0,71,72,7,1,0,0,72,23,1,0,0,0,4,27,46,51,56
    ];
...
export class StatementContext extends antlr.ParserRuleContext {
    ...
    public print_statement(): Print_statementContext | null {
        return this.getRuleContext(0, Print_statementContext);
    }
    public expr_statement(): Expr_statementContext | null {
        return this.getRuleContext(0, Expr_statementContext);
    }
...
export class Print_statementContext extends antlr.ParserRuleContext {
    public constructor(parent: antlr.ParserRuleContext | null, invokingState: number) {
        super(parent, invokingState);
    }
    ...
    public override get ruleIndex(): number {
        return DFOAParser.RULE_print_statement;
    }
    public override enterRule(listener: DFOAListener): void {
...
export class Expr_statementContext extends antlr.ParserRuleContext {
    public constructor(parent: antlr.ParserRuleContext | null, invokingState: number) {
        super(parent, invokingState);
    }
    public expr(): ExprContext {
    ...
    public override get ruleIndex(): number {
        return DFOAParser.RULE_expr_statement;
    }
    public override enterRule(listener: DFOAListener): void {
        if(listener.enterExpr_statement) {
             listener.enterExpr_statement(this);
        }
    }
    public override exitRule(listener: DFOAListener): void {
        if(listener.exitExpr_statement) {
             listener.exitExpr_statement(this);
        }
    }
    public override accept<Result>(visitor: DFOAVisitor<Result>): Result | null {
        if (visitor.visitExpr_statement) {
            return visitor.visitExpr_statement(this);
        } else {
            return visitor.visitChildren(this);
        }
    }
